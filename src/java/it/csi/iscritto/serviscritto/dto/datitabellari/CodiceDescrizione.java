...
package it.csi.iscritto.serviscritto.dto.datitabellari;

////{PROTECTED REGION ID(R-630938892) ENABLED START////}
/**
...
public class CodiceDescrizione implements java.io.Serializable {
	...
	////{PROTECTED REGION ID(R-741883121) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R1267637767) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R-657374757) ENABLED START////}
	/**
	...
	/*PROTECTED REGION ID(R811196581) ENABLED START*/
