...
////{PROTECTED REGION ID(R441453943) ENABLED START////}
/**
 * Inserire qui la documentazione della classe Funzione.
 * Consigli:
 * <ul>
...
public class Funzione implements java.io.Serializable {
	...
	////{PROTECTED REGION ID(R361945674) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R-964519726) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R-2040055944) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R809576945) ENABLED START////}
	/**
	...
	/*PROTECTED REGION ID(R-628773316) ENABLED START*/
