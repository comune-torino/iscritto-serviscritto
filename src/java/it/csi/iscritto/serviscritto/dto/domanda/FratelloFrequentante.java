...
////{PROTECTED REGION ID(R-1658527340) ENABLED START////}
/**
 * Inserire qui la documentazione della classe FratelloFrequentante.
 * Consigli:
 * <ul>
...
public class FratelloFrequentante implements java.io.Serializable {
	...
	////{PROTECTED REGION ID(R-287850617) ENABLED START////}
	/**
	...
	/**
	 * Imposta il valore della property [tipo]
	 * @param val il valore da impostare
	 * @generated
	 */
	...
	////{PROTECTED REGION ID(R-702002488) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R1203090039) ENABLED START////}
	/**
	...
	/*PROTECTED REGION ID(R-2069098619) ENABLED START*/
