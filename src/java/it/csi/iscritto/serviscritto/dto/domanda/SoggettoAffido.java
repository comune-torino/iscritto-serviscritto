...
////{PROTECTED REGION ID(R-460485736) ENABLED START////}
/**
 * Inserire qui la documentazione della classe SoggettoAffido.
 * Consigli:
 * <ul>
...
public class SoggettoAffido implements java.io.Serializable {
	...
	////{PROTECTED REGION ID(R-145157453) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R851530459) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R-1620793477) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R-284503363) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R1421106483) ENABLED START////}
	/**
	 ...
	 * @generated
	 */
	private it.csi.iscritto.serviscritto.dto.domanda.Sentenza sentenza = null;

	/**
	 * Imposta il valore della property [sentenza]
	 * @param val il valore da impostare
	 * @generated
	 */
	public void setSentenza(it.csi.iscritto.serviscritto.dto.domanda.Sentenza val) {
		sentenza = val;
	}

	////{PROTECTED REGION ID(R-2085073728) ENABLED START////}
	/**
	 * Inserire qui la documentazione dell'attributo sentenza. 
	 * Descrivere:
	 * <ul>
	 *      <li>se l'attributo deve essere sempre valoriuzzato o meno
	 *      <li>se ci sono dei vincoli sulla valorizzazione (es. range numerico,
	 ...
	 */
	////{PROTECTED REGION END////}
	public it.csi.iscritto.serviscritto.dto.domanda.Sentenza getSentenza() {
		return sentenza;
	}
	...
	////{PROTECTED REGION ID(R1378847978) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R690676457) ENABLED START////}
	/**
	...
	/*PROTECTED REGION ID(R-1180356287) ENABLED START*/
