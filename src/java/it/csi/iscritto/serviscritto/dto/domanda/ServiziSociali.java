...
////{PROTECTED REGION ID(R-88950055) ENABLED START////}
/**
 * Inserire qui la documentazione della classe ServiziSociali.
 * Consigli:
 * <ul>
...
public class ServiziSociali implements java.io.Serializable {
	...
	////{PROTECTED REGION ID(R-1027085982) ENABLED START////}
	/**
	 ...
	 * @generated
	 */
	private it.csi.iscritto.serviscritto.dto.domanda.DatiServiziSociali dati = null;
	 ...
	 * @generated
	 */
	public void setDati(it.csi.iscritto.serviscritto.dto.domanda.DatiServiziSociali val) {
		dati = val;
	}

	////{PROTECTED REGION ID(R-1696164341) ENABLED START////}
	/**
	 ...
	 */
	////{PROTECTED REGION END////}
	public it.csi.iscritto.serviscritto.dto.domanda.DatiServiziSociali getDati() {
		return dati;
	}
	...
	////{PROTECTED REGION ID(R-1807959051) ENABLED START////}
	/**
	...
	/*PROTECTED REGION ID(R1708331104) ENABLED START*/
