...
////{PROTECTED REGION ID(R1735956337) ENABLED START////}
/**
 * Inserire qui la documentazione della classe ProblemiSalute.
 * Consigli:
 * <ul>
...
public class ProblemiSalute implements java.io.Serializable {
	...
	////{PROTECTED REGION ID(R-156488758) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R-571897251) ENABLED START////}
	/**
	...
	/*PROTECTED REGION ID(R222231752) ENABLED START*/
