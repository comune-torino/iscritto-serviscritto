...
public class DomandaMaternaConverter extends AbstractConverter<DomandaMaternaConverter.Data, DomandaMaterna> {

	@Override
	public DomandaMaterna convert(Data source) {
		...
		if (source != null && source.getDomandaIsc() != null) {
			...
			target.setElencoMaterne(toArray(source.getElencoMaterne(), Materna.class));
	...
	public static final class Data implements Serializable {
		...
		private List<Materna> elencoMaterne;
		private Isee isee;
