package it.csi.iscritto.serviscritto.business.profilazione.spring.startup;
...
public class LoadStartupService implements LoadStartupServiceMBean {
	...
	*/
	...
	public void start() throws Exception {
		...
		try {
			String[] springCfg = new String[]{"META-INF/profilazioneBeanContext.xml",
					"META-INF/profilazioneDao-beans.xml"};
