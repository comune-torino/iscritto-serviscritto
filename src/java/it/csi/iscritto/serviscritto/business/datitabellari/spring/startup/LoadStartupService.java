package it.csi.iscritto.serviscritto.business.datitabellari.spring.startup;
...
public class LoadStartupService implements LoadStartupServiceMBean {
	...
	*/
	...
	public void start() throws Exception {
		...
		try {
			String[] springCfg = new String[]{"META-INF/dati_tabellariBeanContext.xml",
					"META-INF/dati_tabellariDao-beans.xml"};
