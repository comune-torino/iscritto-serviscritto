package it.csi.iscritto.serviscritto.business.scuole.spring.startup;
...
public class LoadStartupService implements LoadStartupServiceMBean {
	...
	*/
	...
	public void start() throws Exception {
		...
		try {
			String[] springCfg = new String[]{"META-INF/scuoleBeanContext.xml", "META-INF/scuoleDao-beans.xml"};
