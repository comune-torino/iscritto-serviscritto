package it.csi.iscritto.serviscritto.business.luoghi.spring.startup;
...
public class LoadStartupService implements LoadStartupServiceMBean {
	...
	*/
	...
	public void start() throws Exception {
		...
		try {
			String[] springCfg = new String[]{"META-INF/luoghiBeanContext.xml", "META-INF/luoghiDao-beans.xml"};
